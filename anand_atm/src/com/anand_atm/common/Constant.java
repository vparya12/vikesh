...
public class Constant {
	...
	public static String GET_ALL_DTH_NUMBER = "SELECT *, DATEDIFF(DATE_ADD(RECHARGEDATE,INTERVAL VALADITY DAY),CURRENT_DATE) AS LEFTDAYS, DATE_ADD(RECHARGEDATE,INTERVAL VALADITY DAY) AS NEXTRECHARGEDATE FROM DTH ORDER BY LEFTDAYS";
	
	public static String GET_ALL_MOBILE_NUMBER = "SELECT *, DATEDIFF(DATE_ADD(RECHARGEDATE,INTERVAL VALADITY DAY),CURRENT_DATE) AS LEFTDAYS, DATE_ADD(RECHARGEDATE,INTERVAL VALADITY DAY) AS NEXTRECHARGEDATE FROM MOBILE ORDER BY LEFTDAYS";
